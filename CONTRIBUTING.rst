...
Django and a Blog could always use more documentation, whether as part of the
official Django and a Blog docs, in docstrings, or even on the web in blog posts,
articles, and such.
...
Ready to contribute? Here's how to set up `django-andablog` for local development.
...
To run a subset of tests::
    ...
    $ python -m unittest tests.test_django-andablog